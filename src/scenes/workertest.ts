  ...
  createScene = async (
    ...
    */
    ...
    if ("OffscreenCanvas" in window) {
      // Offscreen version
      var _canvas: any = document.getElementById("workerRenderCanvas");

      _canvas!.width = canvas.clientWidth;
      _canvas!.height = canvas.clientHeight;
      //@ts-ignore
      var offscreen = _canvas.transferControlToOffscreen();
    }

    var worker = new Worker(
      new URL("../externals/worker-test.js", import.meta.url)
    );
